...
echo.
echo [TIP] To use as a webcam in VideoPsalm, Google Meet, or Zoom WITHOUT OBS:
echo       Run "install_virtual_camera.bat" once as Administrator.
echo       The camera will appear as "Unity Video Capture" in all apps!
echo.
